...
import CityExpenseModal from '../components/EuroExpense/CityExpenseModal';
...
export default function EuroExpensePage({
  ...
  // Reset selected city filter to 'all' on mount to ensure bottom list displays all expenses
  useEffect(() => {
    setSelectedCity('all');
  }, [setSelectedCity]);
  ...
  return (
    <div className="space-y-6 pb-24 md:pb-8">
      ...
      <CityBreakdown
        stats={stats}
        selectedCity="all"
        onSelectCity={(city) => setActiveCityModal(city)}
      />
