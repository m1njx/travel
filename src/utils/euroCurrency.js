...
export const EURO_CITY_TEMPLATES = [
  ...
  { city: '피렌체', country: '이탈리아', flag: '🇮🇹' },
  { city: '베네치아', country: '이탈리아', flag: '🇮🇹' },
  { city: '런던', country: '영국', flag: '🇬🇧' },
  { city: '인터라켄', country: '스위스', flag: '🇨🇭' },
  { city: '프라하', country: '체코', flag: '🇨🇿' },
  { city: '부다페스트', country: '헝가리', flag: '🇭🇺' },
  { city: '바르샤바', country: '폴란드', flag: '🇵🇱' },
  { city: '뮌헨', country: '독일', flag: '🇩🇪' },
  { city: '바르셀로나', country: '스페인', flag: '🇪🇸' },
  { city: '마드리드', country: '스페인', flag: '🇪🇸' },
  { city: '비엔나', country: '오스트리아', flag: '🇦🇹' },
  { city: '암스테르담', country: '네덜란드', flag: '🇳🇱' },
];
